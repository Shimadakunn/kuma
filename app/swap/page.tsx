  ...
  return(
    <>
      <div>
        ...
        <Button onClick={() => toast("hello world")} className="border-2 border-foreground bg-primary text-foreground">Toast</Button>
        <Button onClick={() => toast.success("hello world")} className="border-2 border-foreground bg-primary text-foreground">Toast</Button>
      </div>
    </>
  )
}
